namespace NtErp.Shared.Services.Constants {
    ...
    public static class FinancesModuleMergeKeys {
        public const string RibbonTab = "FinancesModuleRibbonTab";
        public const string RibbonMainGroup = "FinancesModuleRibbonMainGroup";
    }
}
